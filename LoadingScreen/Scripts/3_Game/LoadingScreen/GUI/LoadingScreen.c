/**
 * Custom loading screen implementation for DayZ
 *
 * Adapted for vanilla gameplay without additional dependencies.
 */
...
modded class LoginScreenBase
{
	...
	protected const float LOADING_SCREEN_CHANGE_TIME = 7.0;
